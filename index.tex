...
\authors{Rafik Margaryan, MD, PhD\affil{1}, Giacomo Bianchi, MD,
PhD\affil{2}}
\affiliation{1}{Pentagon, }\affiliation{2}{Curvenote, }
\correspondingauthor{Rafik Margaryan, MD, PhD}{margaryan@ftgm.it}
...
\textsubscript{Source:
\href{https://raffdoc.github.io/manuscript-template/notebooks/explore-earthquakes-preview.html\#cell-fig-spatial-plot}{Explore
Earthquakes}}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.4940}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.4940}}@{}}

\caption{\label{tbl-demographics}Demographics of the first stage}
...
\textsubscript{Source:
\href{https://raffdoc.github.io/manuscript-template/notebooks/clinical_trial_first_stage-preview.html\#cell-tbl-demographics}{First
Stage}}
